          ...
          >
            ...
            <motion.div
              ...
              className={cn(
                ...
                "hover:border-valle-primary/50 hover:shadow-valle-primary/20",
                `ring-2 ${status.ring}`
              )}
...
export default function IntegrationsOrbit() {
  ...
  const iconSize = size.width < 768 ? 48 : 56;

  const connectedCount = integrations.filter(i => i.status === "connected").length;
  const pendingCount = integrations.filter(i => i.status === "pending").length;

  return (
    <section className="py-16 relative min-h-[600px] w-full overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Conecte suas ferramentas favoritas ao ecossistema Valle AI
          </p>
        ...
        <div className="relative flex justify-center">
          ...
          >
            ...
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-valle-navy to-valle-primary flex items-center justify-center shadow-lg shadow-valle-primary/30">
          ...
          >
            ...
            <div className="flex gap-2">
              {selectedIntegration.status === "connected" ? (
                ...
                <Button className="w-full bg-valle-primary hover:bg-valle-primary/90">
