              ...
              <motion.div key={newsItem.id} variants={item}>
                <Card
                  className={`
                    ...
                    hover:border-valle-primary/40 hover:shadow-lg hover:shadow-valle-primary/5
                ...
                >
                  ...
                  <div className="relative aspect-video bg-muted overflow-hidden">
                    {newsItem.image ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-valle-navy/80 to-valle-primary/60 flex items-center justify-center">
                  ...
                  <div className="flex flex-col gap-2 p-4 pt-0">
                    <h3 className="text-lg font-semibold tracking-tight text-foreground line-clamp-2 group-hover:text-valle-primary transition-colors">
                      {newsItem.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between mt-2 pt-3 border-t border-border/40">
                      ...
                      {newsItem.link && (
                        <ExternalLink className="w-4 h-4 text-muted-foreground group-hover:text-valle-primary transition-colors" />
                      )}
                    </div>
                  </div>
                </Card>
