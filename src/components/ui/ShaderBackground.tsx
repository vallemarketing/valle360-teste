...
const ShaderBackground = () => {
  ...
  // Fragment shader source code adaptado para as cores do Valle360
  const fsSource = `
    ...
    void main() {
      ...
      // Cores Valle360: #0f1b35 e variações
      vec4 bgColor1 = vec4(0.059, 0.106, 0.208, 1.0); // #0f1b35
      vec4 bgColor2 = vec4(0.1, 0.15, 0.28, 1.0); // Variação mais clara
